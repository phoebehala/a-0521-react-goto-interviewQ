...
> - phase 1. mounting: loading,  refreshing of the page. That is before we see the change. 
the first time the component get rendered and shown

> - phase 2. updating: like clicking something
If a prop that comes into your component changes, it will cause the component to re-render
the component itself has a state variable that is updating and that will cause the component to re-render

> - phase 3. unmounting: like when we leave the page to go to a different page or hide one of the components
when you no longer want to show a react component on the page
